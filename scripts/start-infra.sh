...
sudo ip netns exec client ip add add 10.0.0.1/24 dev eth0
sudo ip netns exec server1 ip add add 17.0.0.1/24 dev eth0
sudo ip netns exec server2 ip add add 17.0.0.2/24 dev eth0
